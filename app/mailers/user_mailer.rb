class UserMailer < ApplicationMailer
  def send_new_user_message(params)
    ...
    mail(from: 'innovationartsmartiaux@hotmail.ca', to: 'sheldreyn@gmail.com', subject: "Nouveau client: #{params.email}", cc: 'sheldreyn@gmail.com')
  end
  ...
  def send_new_reservation_message(params)
    ...
    mail(from: 'innovationartsmartiaux@hotmail.ca', to: 'sheldreyn@gmail.com', subject: "Nouvelle réservation: #{@reservation['student_name']} - (#{@reservation['client_name']}) ", cc: 'sheldreyn@gmail.com')
  end
  ...
  def send_reservation_confirmed_message(params)
    ...
    mail(from: 'innovationartsmartiaux@hotmail.ca', to: 'sheldreyn@gmail.com', subject: "Réservation confirmée: #{@reservation['student_name']} - (#{@reservation['client_name']}) ", cc: 'sheldreyn@gmail.com')
  end
